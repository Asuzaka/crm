...
import { INVALIDID, INVALIDQUERORNOQUERY, NODOCUMENTFOUND, NOIDPROVIDED, SUCCESS } from "../constants/errors";
...
export const getUser = catchAsync(async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
...
export const createUser = catchAsync(async (req: AuthenticatedRequest, res: Response, _: NextFunction) => {
  // Create user
...
export const updateMe = catchAsync(async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  ...
  const updatedUser: IUser | null = await User.findOneAndUpdate({ email: req.user.email }, updateUser, { new: true });
...
export const updateUser = catchAsync(async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  ...
  const updatedUser: IUser | null = await User.findByIdAndUpdate(id, updateUser, { new: true, runValidators: false });
...
export const deleteUser = catchAsync(async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
...
export const searchUsers = catchAsync(async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  // search for groups
