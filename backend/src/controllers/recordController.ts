...
export const getRecords = catchAsync(async(req: AuthenticatedRequest, res: Response, next: NextFunction)=>{
  ...
  const records : IRecord[] = await features.getQuery();

  res.status(OK).json({ status: SUCCESS, data: records, result: records.length});
})
...
export const createRecords = catchAsync(async(req: AuthenticatedRequest, res: Response, next: NextFunction)=>{

})
// patch Record update //id 
export const updateRecords = catchAsync(async(req: AuthenticatedRequest, res: Response, next: NextFunction)=>{

})
// delete Record delete 
export const deleteRecords = catchAsync(async(req: AuthenticatedRequest, res: Response, next: NextFunction)=>{
