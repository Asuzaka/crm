...
export const getExpenses = catchAsync(async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  const { id } = req.params;
  ...
  const featuresForCount = new apiFeatures(query, req.query).filter().search(["description", "notes"]);
...
// personal payment
export const getExpense = catchAsync(async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  // id from param  || GET
  const { id } = req.params;
  ...
  const expense: IExpense | null = await Expense.findById(id).populate("manager", "_id name");
...
export const createExpense = catchAsync(async (req: AuthenticatedRequest, res: Response, _next: NextFunction) => {
...
// permission
export const updateExpense = catchAsync(async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
...
// permission
export const deleteExpences = catchAsync(async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
