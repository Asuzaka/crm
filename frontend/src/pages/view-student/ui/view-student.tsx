      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center">
            <Link to="/students" className="mr-4 text-blue-600 hover:text-blue-800">
          ...
          <div className="px-4 py-5 sm:px-6 flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm text-gray-500">Student ID: {data?.data._id}</p>
              </div>
            </div>
            <span
          ...
          <div className="border-t border-gray-200">
            <dl>
              ...
              <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{data?.data.phoneNumber}</dd>
              </div>
              <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500 flex items-center">
                  ...
                  {data.data.groups.length > 0 ? (
                    <div>
                      {data?.data.groups.map((group) => (
                        <li key={group._id} className="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                          <div className="w-0 flex-1 flex items-center">
                            <span className="ml-2 flex-1 w-0 truncate">{group.name}</span>
                          </div>
                    ...
                    <div className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">No groups</div>
                  )}
                </dd>
              </div>
              <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
