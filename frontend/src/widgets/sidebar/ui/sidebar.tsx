  ...
  return (
    <>
      ...
      <div className="fixed top-4 left-4 z-20 md:hidden">
        <button onClick={toggleMobileMenu} className="p-2 rounded-md bg-blue-600 text-white focus:outline-none">
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-center h-16 bg-blue-800">
            <span className="text-white text-xl font-bold">Learning Center</span>
          </div>
