    ...
    <div className="bg-white shadow rounded-lg">
              ...
              <tr key={student._id} className="hover:bg-gray-50">
                ...
                {months.map((_, monthIndex) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex justify-center">{getPaymentStatusIcon(status)}</div>
                    </td>
                  );
                })}
              </tr>
      ...
      <div className="px-6 py-4 border-t border-gray-200">
        <p className="text-sm text-gray-500">
          This overview is automatically generated based on payment records. To see detailed payment information, check
          the Income section.
        </p>
      </div>
    </div>
